...
$auth_username=$_POST["username"];  // extract the username from the post request sent form created for input
$auth_password=$_POST["password"]; // extract the password from the post request and send it to the user form 
